  ...
  return (
    <ChakraProvider theme={theme}>
      <Box textAlign="center" fontSize="xl">
        ...
        <a href="https://new.cosmonic.app/?yaml=https://raw.githubusercontent.com/cosmonic/awesome-cosmonic/main/xkcdgenerator/xkcd-generator-cosmonic.wadm" target="_blank" rel="noreferrer">
        <Image
          src="deploy-xkcd-on-cosmonic.png"  // Update with the correct path
          alt="Deploy XKCD on Cosmonic Now"
          style={{
            position: 'absolute',
            bottom: 0,
            left: 0,
